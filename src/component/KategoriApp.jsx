...
const KategoriApp = ({ title, img, desc, price, kat, link }) => {
  ...
  return (
    <a style={{ textDecoration: 'none' }} href={link}>
      <Card style={{ width: '364.55px', height: '391px', borderRadius: '19.24px', marginBottom: '50px', boxShadow: '0px 0px 6.25px 0px rgba(0,0,0,0.25)', overflow: 'hidden' }}>
        <Card.Img style={{ height: '244.31px' }} variant="top" src='../assets/kategori-app/database.png' alt={title} />
        <Card.Body className="d-flex gap-2">
          ...
          <div className="d-flex flex-column w-100">
            ...
            <div className="d-flex flex-column align-items-end">
              ...
              <p style={{ marginBottom: '0', fontSize: '14.43px', color: '#19a7ce' }}>{formatRupiah(price)}</p>
            </div>
          </div>
        </Card.Body>
      </Card>
